...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_todolist_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\r\n.container {\r\n  padding: 20px;\r\n  margin: 0 auto;\r\n  width: 400px; \r\n  border: 1px solid gainsboro;\r\n\r\n  text-align: left;\r\n}\r\n\r\n.container .body {\r\n  border: 1px solid gainsboro;\r\n  margin: 20px 0;\r\n  padding: 10px;\r\n  padding-right: 50px;\r\n}\r\n\r\n\r\n.container .body .todolist-item {\r\n  margin: 5px 0;\r\n\r\n  display: flex;\r\n  align-items: center;\r\n  height: 30px;\r\n}\r\n\r\n.container .body .todolist-item:hover {\r\n  background-color: gainsboro;\r\n}\r\n\r\n.container .body .todolist-item button {\r\n  margin-left: auto;\r\n  display: none;\r\n}", ""]);
// Exports
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _todolist_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* provided dependency */ var $ = __webpack_require__(11);

var complete = 0;
var total = 0;
console.log('开始啦');
$(function () {
  console.log('看看是否走到了这儿'); // 如果是单例模式，可以把方法都写在里面！
  ...
  function Person(name, age) {
    ...
    this.speak = function () {// alert(this.name + this.age);
    };
  }
  ...
  Person.prototype = {
    constructor: Person,
    // N个实例1份
    run: function run() {// console.log(`${this.name} is running!`);
    }
  };
  ...
  $(".container .footer span").text("\u5DF2\u5B8C\u6210".concat(complete, " / \u5168\u90E8").concat(total));
  $(".container .body .todolist-item input").change(function () {
    $(".container .footer span").text("\u5DF2\u5B8C\u6210".concat($(":checked").length, " / \u5168\u90E8").concat(total));
  });
  $(".container .body .todolist-item").mouseover(function () {
  ...
  $("#deleteAll").click(function () {
    ...
    $(".container .footer span").text("\u5DF2\u5B8C\u62100 / \u5168\u90E8".concat(total));
  });
  ...
  $("#input").keypress(function (e) {
    if (e.which == 13) {
      ...
      var dom = $("<div class=\"todolist-item\">\n        <input type=\"checkbox\" name=\"\" id=".concat(id, ">\n        <label for=").concat(id, ">\n          <span>").concat(e.target.value, "</span>\n        </label>\n        <button>\u5220\u9664</button>\n      </div>"));
